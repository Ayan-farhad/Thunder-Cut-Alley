    ...
    return (
        <div className='main-navTabs'>
            ...
            <div className='tabs-img' style={{display: 'flex', justifyContent: 'center', marginTop: '2rem'}}>
                <img src={brunch} alt='brunch'  className="tabs-image" style={{ display: activeTab === 'brunch' ? 'block' : 'none' }} />
                <img src={night} alt='night' className="tabs-image"  style={{ display: activeTab === 'night' ? 'block' : 'none' }} />
                <img src={drinks} alt='drinks'  className="tabs-image" style={{ display: activeTab === 'drinks' ? 'block' : 'none' }} />
            </div>
        </div>
    );
}
